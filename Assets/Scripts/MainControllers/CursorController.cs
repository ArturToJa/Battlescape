...
public class CursorController : MonoBehaviour
{
    ...
    private void CheckForAttackState()
    {
        ...
        if (MouseManager.Instance.MouseoveredUnit != null && MouseManager.Instance.SelectedUnit != null)
        {
            ...
            else if (MouseManager.Instance.MouseoveredUnit.GetComponent<UnitScript>().PlayerID == TurnManager.Instance.PlayerToMove)
            {
                SetCursorTo(clickingSelectionCursor, selectionCursor);
            }
            else
    ...
    {
        if (MouseManager.Instance.MouseoveredUnit.PlayerID == TurnManager.Instance.PlayerToMove)
        {
