...
//                if ((Pathfinder.instance.GetDistanceFromTo(myUnit, tile) == myUnit.statistics.movementPoints) && tile.IsProtectedByEnemyOf(myUnit) && tile.IsWalkable())
//                {
...
//            {
//                int distance = 0; // Pathfinder.instance.GetDistanceFromTo(myUnit, enemy.currentPosition);
